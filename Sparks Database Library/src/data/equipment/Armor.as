...
package data.equipment {
	...
	public class Armor extends Equipment implements IArmor {
		...
		public function Armor( xmlRoot:String=NAME, name:String="", description:String="", type:String="", scale:String="", skill:String="",
							   availabilityRarity:Vector.<String>=null, availabilityLegal:Vector.<String>=null, cost:String="",
							   protection:Vector.<String>=null, penalties:Vector.<String>=null, gameNotes:String="", campaignNotes:String="",
							   sources:Vector.<ISource>=null ) {

			super( xmlRoot, name, description, model, type, scale, skill, availabilityLegal, availabilityLegal, cost, gameNotes, campaignNotes,
				   sources );
		}
	}
}