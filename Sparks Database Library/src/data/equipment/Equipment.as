...
package data.equipment {
	...
	public class Equipment extends AbstractEquipment implements IEquipment {
		...
		public function Equipment( xmlRoot:String=NAME, name:String="", description:String="", model:String="", type:String="", scale:String="",
								   skill:String="", availbilityRarity:Vector.<String>=null, availbilityLegal:Vector.<String>=null, cost:String="",
								   gamesNotes:String="", campaignNotes:String="", sources:Vector.<ISource>=null ) {
